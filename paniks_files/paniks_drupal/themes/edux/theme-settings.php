...
function edux_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['general'] = [
    '#type'  => 'details',
    '#title' => t('General'),
    '#description' => t('<h3>Thanks for using EduX Theme</h3><strong>Edu X</strong> is a free Drupal 8, 9 theme designed and developed by <a href="https://www.drupar.com" target="_blank">Drupar.com</a>'),
    '#group' => 'edux',
  ];
  $form['layout'] = [
    '#type'  => 'details',
  ...
  $form['general']['general_info'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Theme Info'),
    '#description' => t('<a href="https://www.drupar.com/theme/edux" target="_blank">Theme Homepage</a> || <a href="https://demo2.drupar.com/edux/" target="_blank">Theme Demo</a> || <a href="https://www.drupar.com/edux-documentation" target="_blank">Theme Documentation</a> || <a href="https://www.drupar.com/edux-documentation/support" target="_blank">Theme Support</a>'),
  ];
  ...
  $form['slider']['slider_code'] = [
    ...
    '#description'   => t('Please refer to this <a href="https://www.drupar.com/edux-documentation/homepage-slider" target="_blank">documentation page</a> for slider code tutorial.'),
  ];
  /*
   * Header
   */
  ...
  $form['header']['header_links']['header_links_section'] = [
    '#type'        => 'fieldset',
    '#description'   => t('<a href="https://www.drupar.com/edux-documentation/how-manage-website-logo" target="_blank">Change Logo</a> || <a href="https://www.drupar.com/edux-documentation/how-change-favicon-icon" target="_blank">Change Favicon Icon</a> || <a href="https://www.drupar.com/edux-documentation/header-main-menu" target="_blank">Manage Main Menu</a> || <a href="https://www.drupar.com/edux-documentation/sliding-search-form" target="_blank">Sliding Search Form</a>'),
  ];
  // Header -> Login Links
  ...
  $form['insert_codes']['css']['css_section']['styling'] = [
    ...
    '#description'   => t("Check this option to enable custom styling. Uncheck to disable this feature.<br />Please refer to this tutorial page. <a href='https://www.drupar.com/edux-documentation/custom-css' target='_blank'>How To Use Custom Styling</a>"),
  ];
  ...
  $form['insert_codes']['css']['css_section']['styling_code'] = [
    ...
    '#description'   => t('Please enter your custom css codes in this text box. You can use it to customize the appearance of your site.<br />Please refer to this tutorial for detail: <a href="https://www.drupar.com/edux-documentation/custom-css" target="_blank">Custom CSS</a>'),
  ];
  ...
  $form['support']['info'] = [
    ...
    <p>Please check our full documentation for detailed information on how to use Edu X theme.<br /><a href="https://www.drupar.com/edux-documentation" target="_blank">Edu X Theme Documentation</a>.</p>
    <hr />
    <h4>Create Issue</h4>
